...
var MyStockChart = function () { return (createElement(HighchartsReact, { highcharts: Highcharts, constructorType: 'stockChart', options: options })); };
...
var ExampleComponent = /** @class */ (function (_super) {
    ...
    ExampleComponent.prototype.render = function () {
        return (createElement("div", { className: styles.test },
            createElement(MyStockChart, null)));
    };
